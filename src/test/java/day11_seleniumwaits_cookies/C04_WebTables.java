...
public class C04_WebTables extends TestBase {
    ...
    public void test01(){
        ...
        List<WebElement>ucuncuSatirSutunListesi = driver.findElements(By.xpath("//tbody/tr[1]/td"));
    ...
    private WebElement getElement(int satir, int sutun) {
        String dinamikXpacth ="//tbody/tr["+satir+"]/td["+sutun+"]";

        WebElement istenenElement = driver.findElement(By.xpath(dinamikXpacth));

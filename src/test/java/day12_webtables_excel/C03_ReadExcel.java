...
public class C03_ReadExcel {
    ...
    public void test01() throws IOException {
        //ulkeler excelîndeki sayfa1'e gidecek seklde ayarlari yapalim
        ...
        System.out.println("ikinci sayfa son satir indexi :" +workbook.getSheet("Sayfa2").getLastRowNum());
        System.out.println("ikinci sayfa fiziki kullanilan satir sayisi : "+workbook.getSheet("Sayfa2").getPhysicalNumberOfRows());

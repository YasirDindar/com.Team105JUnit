...
public class C04_IFrame {
    ...
    public void test() throws InterruptedException {
       ...
       WebElement actualSayfaYazisiElementi = driver.findElement(By.tagName("h3"));
        ...
        /*
        normal locate yapip yazdirmayi denedigimizde
        NoSuchElementException verdi. Yani elementi bulamadi
        Kontrol ederken  istedigimiz webelement'in
        bir iframe icinde oldugunu gorduk
        bu durumda once o iframe'e swichTo() yapmaliyiz
         */
       ...
       // driver.switchTo().parentFrame(); //bulundugu iframe'den bir ust html sayfasina gecer
        ...
        WebElement elemantalSeleniumLinkElementi = driver.findElement(By.xpath("//div[@style='text-align: center;']"));
